...
## Overview
A data‑science exploration of allele‑specific expression (ASE) and GWAS effect sizes in complex disorders (e.g. schizophrenia, scoliosis).  
This project combines transcriptomic data (ASE), genetic association results (GWAS), and visualization to uncover regulatory patterns across diseases.
...
Any other raw/processed data files…
